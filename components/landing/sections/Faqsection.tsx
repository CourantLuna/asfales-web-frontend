...
export default function FAQSection() {
  return (
    <section className="w-full px-6 py-8 bg-background ">
     <div className="max-w-7xl mx-auto">
         <h2 className="text-3xl font-bold tracking-tight text-gray-800 text-center">Preguntas Frecuentes</h2>
      ...
      <Accordion type="single" collapsible className="space-y-4">
        <AccordionItem value="item-1">
          <AccordionTrigger>¿Qué es Asfales y cómo funciona?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger>¿Cómo busco y comparo opciones de viaje?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger>¿Cómo creo, edito y comparto un itinerario?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger>¿Cómo funcionan las alertas y notificaciones?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-6">
          <AccordionTrigger>¿Cómo puedo contactar al soporte?</AccordionTrigger>
          <AccordionContent>
