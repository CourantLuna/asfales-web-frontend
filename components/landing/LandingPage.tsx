...
function smoothScrollTo(targetY: number, duration = 800) {
  ...
  const handleSearch = (origin: string, destination: string) => {
    ...
    smoothScrollTo(resultsRef.current?.offsetTop ?? 0, 1000); // Ajusta el desplazamiento vertical();
  }
  ...
  return (
    ...
    <div className="min-h-screen w-full bg-[#F8FAFC]">
      ...
      <div className="relative min-h-svh">
        ...
        {searchValues ? (
          <SearchResultsPanel origin={searchValues.origin} destination={searchValues.destination} />
        ) : (
          <>
            <WhyAsfales />
            <ComparisonDemo />
